...
export const PHASE_INSTRUCTIONS: Record<PhaseLabel, string> = {
  ...
  P1_FLOW_ABS: "Build your attention baseline with moving patterns.",
  P2_ARROW_ABS: "The same skill now appears in static arrows. A short dip is normal when the format changes.",
  P3_FLOW_REL: "Now the motion task becomes relative to the centre.",
  P4_ARROW_REL: "You will practise recovering relative direction in static arrows.",
