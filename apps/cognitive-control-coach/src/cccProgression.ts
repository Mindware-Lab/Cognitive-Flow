...
export const COGNITIVE_CONTROL_STAGE_SEQUENCE: readonly CccProgressionStage[] = [
  {
    id: "P0",
    label: "Absolute Attention carrier transfer and core value mechanic",
    releaseGate: "private_pilot",
    steps: [
      {
        id: "p0_arrow_abs_stabilize",
        stage: "P0",
        order: 1,
        operator: "attention",
        label: "Stabilise absolute arrows",
      ...
      {
        id: "p0_flow_abs_transfer",
        stage: "P0",
        order: 2,
        operator: "attention",
        label: "Transfer absolute rule to flow",
        sourceWrapperId: "arrow_abs",
        targetWrapperId: "flow_abs",
  ...
  {
    id: "P1a",
    label: "Relative-rule extension and full Attention Portability",
    releaseGate: "private_pilot",
    steps: [
      {
        id: "p1a_arrow_rel_extension",
        stage: "P1a",
        order: 3,
        operator: "attention",
        label: "Introduce relative rule in arrows",
        sourceWrapperId: "arrow_abs",
        targetWrapperId: "arrow_rel",
        wrappers: ["arrow_abs", "arrow_rel"],
      ...
      {
        id: "p1a_flow_rel_transfer",
        stage: "P1a",
        order: 4,
        operator: "attention",
        label: "Transfer relative rule to flow",
      ...
      {
        id: "p1a_mixed_attention_portability",
        stage: "P1a",
        order: 5,
        operator: "attention",
        label: "Mix all four attention formats",
        sourceWrapperId: null,
        targetWrapperId: null,
        wrappers: ["arrow_abs", "flow_abs", "arrow_rel", "flow_rel"],
