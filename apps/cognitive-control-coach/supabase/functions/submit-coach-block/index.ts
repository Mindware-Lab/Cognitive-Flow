...
Deno.serve(async (request) => {
  ...
  const trialRows = trials.map((value) => {
    ...
    return {
      ...
      estimand: stringValue(trial.estimand) || null,
      presentation_mode: stringValue(trial.presentationMode) || null,
      ...
      is_valid_decision: stringValue(trial.responseClass) === "answer",
      is_omission: stringValue(trial.responseClass) === "omission",
      counts_toward_quota: booleanValue(trial.countsTowardQuota),
      ...
      exposure_ms_requested: numberValue(trial.exposureMsRequested),
      exposure_ms_actual: numberValue(trial.exposureMsActual),
      actual_stimulus_frames: numberValue(trial.actualStimulusFrames),
      device_refresh_rate_estimate: numberValue(trial.deviceRefreshRateEstimate),
      timing_quality: stringValue(trial.timingQuality) || null,
      signal_staircase_level: numberValue(trial.signalStaircaseLevel),
