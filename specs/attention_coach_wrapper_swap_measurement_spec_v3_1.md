...
## v3.1 — fixed 20-session carrier-swap transfer programme aligned with Zhang–Tang trajectory metrics

**Status:** revised measurement specification with fixed commercial 20-session programme  
**Supersedes:** v3.0 and v2.0 “Wrapper-Swap Progression & Metric Calculation Specification”  
