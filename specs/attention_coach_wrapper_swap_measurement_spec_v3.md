...
## v3.0 — carrier-swap transfer model aligned with Zhang–Tang trajectory metrics

**Status:** revised measurement specification  
**Supersedes:** v2.0 “Wrapper-Swap Progression & Metric Calculation Specification”  
...
### 4.2 Nominal 20-session schedule

The schedule is nominal. Gates can extend or compress phases depending on learning-curve evidence.

| Nominal sessions | Phase | Primary cell(s) | Purpose |
|---:|---|---|---|
| 1–4 | P1 | `arrow_abs` | establish first-carrier absolute baseline |
| 5–8 | P2 | `flow_abs` | measure base carrier-swap recovery |
| 9–12 | P3 | `arrow_rel` | establish arrow relational-abstraction signature |
| 13–16 | P4 | `flow_rel` | validate flow relational abstraction and relational carrier transfer |
| 17–18 | P5 | all four | mixed carrier × frame stability |
| 19–20 | P6 | all four | delayed mixed re-check |

For a faster commercial arc, the same order can be compressed into:
...
3 sessions P4
2–3 sessions mixed
1–2 sessions delayed
```

For research-quality trajectory metrics, retain the longer 20-session structure where possible.
...
- [ ] Keep technical metrics out of consumer UI.
